...
while len(dog_name) == 0:
    dog_name = input('Your friend has a longer name than that..... Reach out... The name is: ')
else:
...
while len(dog_breed) == 0:
    dog_breed = input('That\'s... that\'s not a breed, that\'s nothing, come on, reach out, what is our friend?:  ')
else:
    print()
...
while len(fav_smell) == 0:
    fav_smell = input('No, that can\'t be it, try again:  ')
else:
    print()
...
while len(sec_breed) == 0:
    sec_breed = input('Our dog has many friends, so it\'s hard to think of just one, but focus:  ')
else:
    print()
...
while len(scary_thing) == 0:
    scary_thing = input('Nothingness can be scary, but it\'s not what our friend is scared of, try again:  ')
else:
    print()
...
while True:
    x = input('Do you comfort your human or let them comfort you? Choose 1 to comfort, 2 to receive comfort:  ')
    if x == '1' or x == '2':
        break
if x == '1':
